...
public class DeadAlien extends Actor {
	...
	/**
	 * Constructs the DeadAlien to be in the place of the dead alien, with the
	 * direction and movement set to be the same as the alien.
	 * 
	 * @param oct
	 *            the dead Alien that is passed in
	 */
	...
	/**
	 * Makes the DeadAlien move for ten act calls, then removes itself from the
	 * world.
	 */
	public void act() {
		time++;
